        ...
        <div className="w-full block 800px:flex items-center justify-between">
          <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
            <div className="flex items-center">
              ...
              <h3 className="text-[#333] font-600 font-Roboto text-[18px] leading-5 !font-[400] text-[#00000085]">
                Account Balance
          ...
          <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
            ...
            <h5 className="pt-2 pl-[36px] text-[22px] font-[500]">{orderShop && orderShop?.length}</h5>
          ...
          <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
            ...
            <h5 className="pt-2 pl-[36px] text-[22px] font-[500]">{shopProduct && shopProduct?.length}</h5>
